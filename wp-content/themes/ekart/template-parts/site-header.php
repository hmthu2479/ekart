		...
		<div class="wf_header-navwrapper">
			<div class="wf_header-navwrapperinner">
				...
				<div class="wf_navbar wf-d-none wf-d-lg-block">					
					...
					<div class="wf_navbar-wrapper <?php if($shopire_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','ekart'); endif; ?>">
						<div class="wf-container">
				...
				<div class="wf_mobilenav wf-d-lg-none <?php if($shopire_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','ekart'); endif; ?>">
